...
SECRET_KEY = 'django-insecure-g&)s!8tyj$xl)@+auzsf*_n0^2^xye@3dsqoq1j-m)myv$pm27'
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / "Backend/Document/templates"],  # global access
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [BASE_DIR / "Backend/Document/static"]  # optional global static
